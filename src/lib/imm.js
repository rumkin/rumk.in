export function doIn(target, path, fn) {
    if (! path.length) {
        return target;
    }
...
export function mapIn(target, path, fn) {
    return doIn(target, path, (value = []) => {
        return map(value, fn);
    });
}

export function addLast(array, value) {
...
export function addLastIn(target, path, item) {
    return doIn(target, path, (value = []) => {
        return addLast(value, item);
    });
}

export function addFirst(array, value) {
    return Object.freeze([
        freezed(value),
        ...array,
    ]);
...
export function addFirstIn(target, path, item) {
    return doIn(target, path, (value = []) => {
        return addFirst(value, item);
    });
}

export function removeAt(array, n) {
    return Object.freeze([
        ...array.slice(0, n),
        ...array.slice(n + 1),
    ]);
...
export function removeAtIn(target, path, n) {
    return doIn(target, path, (value = []) => {
...
export function removeFirstIn(target, path, n) {
    return doIn(target, path, (value = []) => {
...
export function removeLastIn(target, path, n) {
    return doIn(target, path, (value = []) => {
...
export function filterIn(target, path, fn) {
    return doIn(target, path, (value = []) => {
        return filter(value, fn);
    });
}

export function get(target, prop, alt) {
...
export function getIn(target, path, alt) {
    if (! path.length) {
        return target;
    }
    else if (path.length > 1) {
...
export function setIn(target, path, val) {
    if (path.length < 1) {
        return target;
    }
...
export function update(target, prop, fn) {
...
export function updateIn(target, path, fn) {
    if (path.length < 1) {
        return target;
    }
    else if (path.length < 2) {
...
export function remove(target, prop) {
...
export function removeIn(target, path) {
    if (path.length < 1) {
        return target;
    }
    else if (path.length < 2) {
...
export function item(arr, i, value) {
...
export function itemIn(target, path, value) {
    if (path.length < 1) {
        return target;
    }
    else if (path.length < 2) {
...
export function mergeIn(target, path, value) {
    if (path.length < 1) {
        return target;
    }
    else if (path.length < 2) {
...
export function freezed(target) {
...
export function assign(target, props) {
    return Object.freeze(
